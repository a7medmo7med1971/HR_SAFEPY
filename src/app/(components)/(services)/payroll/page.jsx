...
export const metadata = {
  title: "إدارة الرواتب | HRSafPay",
  description:
    "حلول HRSafPay لإدارة الرواتب تضمن الدقة، السرعة، والشفافية في صرف الرواتب والمكافآت، مع التوافق الكامل مع القوانين المحلية.",
  openGraph: {
    title: "إدارة الرواتب مع HRSafPay",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "خدمات إدارة الرواتب - HRSafPay",
      },
    ],
    locale: "ar_EG",
    type: "article",
      ...
      <section className="py-16 px-6 md:px-20 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 md:text-right">
          <h2 className="text-2xl md:text-4xl font-bold text-indigo-900">
            لماذا إدارة الرواتب مع HRSafPay؟
          </h2>
          <p className="text-gray-600 leading-relaxed">
            الرواتب هي أحد أهم عناصر رضا الموظفين وثقتهم بالشركة. في HRSafPay
          ...
          <p className="text-gray-600 leading-relaxed">
            مع HRSafPay، نضمن لك عملية دفع سلسة، شفافة، وسريعة، تعزز من رضا
